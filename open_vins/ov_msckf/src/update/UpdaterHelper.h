...
namespace ov_msckf {
    ...
    public:
        ...
        static void calculate_cubature_points(std::shared_ptr<State> state, Eigen::MatrixXd P, Eigen::MatrixXd &sigma_points_);

        static bool single_triangulation_and_gaussnewton(std::shared_ptr<State> state, UpdaterHelperFeature &feature, Eigen::MatrixXd &sigma_cam_states_, Eigen::Vector3d &p_FinG);
        static bool single_gaussnewton(std::shared_ptr<State> state, UpdaterHelperFeature &feature, Eigen::MatrixXd &sigma_cam_states_, Eigen::Vector3d &p_FinA, Eigen::Vector3d &p_FinG);
        static double compute_error(std::shared_ptr<State> state, UpdaterHelperFeature &feature, Eigen::MatrixXd &sigma_cam_states_, double alpha, double beta, double rho);

        static int pass_sigma_points(std::shared_ptr<State> state, UpdaterHelperFeature &feature, Eigen::MatrixXd &sigma_points_, Eigen::MatrixXd &P_zz, Eigen::MatrixXd &z_sigmas, Eigen::VectorXd &z_measured, Eigen::VectorXd &res, Eigen::MatrixXd &R);
        // static void calc_residual_CKF(std::shared_ptr<State> state, UpdaterHelperFeature &feature, Eigen::MatrixXd &sigma_points_, Eigen::MatrixXd &P_xz, Eigen::MatrixXd &P_zz, Eigen::VectorXd &res, Eigen::MatrixXd &R);
