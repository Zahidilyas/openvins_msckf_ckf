...
namespace ov_msckf {
    ...
    public:
        ...
        // static void CKF_update(std::shared_ptr<State> state, Eigen::MatrixXd &P_xz, Eigen::MatrixXd &P_zz, Eigen::VectorXd &res, Eigen::MatrixXd &P);
        // static void CKF_update(std::shared_ptr<State> state, const Eigen::MatrixXd sigma_points_, const Eigen::MatrixXd z_stacked, const Eigen::VectorXd z_measured_big, const Eigen::MatrixXd P, const Eigen::MatrixXd R);
        static void CKF_update(std::shared_ptr<State> state,
